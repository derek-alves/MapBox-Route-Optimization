...
class busca(object):
    ...
    def profundidade_limitada(self, inicio, fim, limite):
        ...
        texto = str(limite) + " etimil arap odartnocne oãn ohnimaC"    
        return texto
...
caminho = sol.amplitude("A","B")
#print("Amplitude.......: ",caminho[::-1])
print("Amplitude.......: ",caminho)



caminho = sol.profundidade("A","B")
print("Profundidade....: ",caminho[::-1])


caminho = sol.profundidade_limitada("A","B",2)
print("Prof. Limitada..: ",caminho[::-1])
caminho = sol.profundidade_limitada("A","B",3)
print("Prof. Limitada..: ",caminho[::-1])
caminho = sol.profundidade_limitada("A","B",4)
print("Prof. Limitada..: ",caminho[::-1])

caminho = sol.aprofundamento_iterativo("A","B",10)
print("Aprof. Iterativo: ",caminho[::-1])

"""
caminho = sol.bidirecional("A","B")
